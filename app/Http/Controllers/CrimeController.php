...
class CrimeController extends Controller
{
    ...
    public function update(Request $request, Crime $crime)
    {
        ...
        return redirect()->route('crimes.show', $crime->id)->with('success', 'Crime details updated successfully.');
    }
    ...
    public function destroy(Crime $crime)
    {
        ...
        return redirect()->route('crimes.index')->with('success', 'Crime deleted successfully.');
    }
}
