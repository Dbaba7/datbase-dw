                ...
                <div class="p-6 bg-white border-b border-gray-200">
                    <form method="POST" action="{{ route('admin.officers.store') }}">
                        ...
                        <div class="mt-4">
                            ...
                            <x-text-input id="rank" class="block mt-1 w-full" type="text" name="rank" :value="old('rank')" required autofocus />
                        </div>
                        ...
                        <div class="mt-4">
                            ...
                            <x-text-input id="badge_number" class="block mt-1 w-full" type="text" name="badge_number" :value="old('badge_number')" required />
                        </div>
